...
public class ControlFrame extends JFrame {
    ...
    private static final Integer DEFAULT_IMMORTAL_HEALTH = 100;
        ...
        btnResume.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (Immortal im : immortals) {
                 ...
                 synchronized (DEFAULT_IMMORTAL_HEALTH) {
                    DEFAULT_IMMORTAL_HEALTH.notifyAll();
                }
            }
        });
    ...
    public List<Immortal> setupInmortals() {
        ...
        try {
            ...
            for (int i = 0; i < ni; i++) {
                Immortal i1 = new Immortal("im" + i, il, DEFAULT_IMMORTAL_HEALTH, DEFAULT_DAMAGE_VALUE, ucb,DEFAULT_IMMORTAL_HEALTH);
                il.add(i1);
            }
            return il;
